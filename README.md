...
- 此時不要關閉命令視窗，以瀏覽器開啟 http://127.0.0.1:8000/ ，打開 Django 專案的網頁。
...
- 本專案可接受的資料樣態
    ...
    - 範例：( 逗號之間請勿填充空白格，也不要在資料中間任意換行，以免程式讀取錯誤 )
...
5. 使用『門檻值轉換器』，開啟網頁【 http://127.0.0.1:8000/convert_threshold/ 】。
...
4. 在 templates 樣板目錄下新增一個 base.html。
